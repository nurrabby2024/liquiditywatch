...
Tracks liquidity pool changes for a pair and alerts on large moves.
...
```bash
git clone https://github.com/nurrabby2024/liquiditywatch.git
cd liquiditywatch
```
